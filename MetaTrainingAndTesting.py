...
import MetaFeatureTrainingPreprocessing
...
if constants.save:
    ...
    #error if directory doesnt exist
    directory = MetaFeatureTrainingPreprocessing.TrainingAndTesting.directory
    ...
    #filename (features)
    tf = directory + str('/nMetaNonTextFeature.pkl')
