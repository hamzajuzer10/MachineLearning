...
def TrainAndTest():
    ...
    print 'training %s classifier on Confidentiality FinLoss...' % constants.classifier['FLconfidentiality']
    ...
    print 'training %s classifier on Confidentiality CusD...' % constants.classifier['CDconfidentiality']
    ...
    print 'training %s classifier on Confidentiality RepLoss...' % constants.classifier['RPconfidentiality']
    ...
    print 'training %s classifier on Confidentiality RegLoss...' % constants.classifier['RGconfidentiality']
    ...
    print 'training %s classifier on Integrity FinLoss...' % constants.classifier['FLintegrity']
    ...
    print 'training %s classifier on Integrity CusD...' % constants.classifier['CDintegrity']
    ...
    print 'training %s classifier on Integrity RepLoss...' % constants.classifier['RPintegrity']
    ...
    print 'training %s classifier on Integrity RegLoss...' % constants.classifier['RGintegrity']
    ...
    print 'training %s classifier on Availability FinLoss...' % constants.classifier['FLavailability']
    ...
    print 'training %s classifier on Availability CusD...' % constants.classifier['CDavailability']
    ...
    print 'training %s classifier on Availability RepLoss...' % constants.classifier['RPavailability']
    ...
    print 'training %s classifier on Availability RegLoss...' % constants.classifier['RGavailability']
